...
const ListItem = ({data1, data2, hanger}) => (
  <div className="small-block">
    {hanger && <div className="hanger">MVP</div>}
    <div className="item-block d-flex flex-row align-items-center">
      <div className="left">{data1.leftText}</div>
      <div className={classNames('right', data1.color)}>{data1.status}</div>
    </div>
    {data2 && <div className="item-block d-flex flex-row align-items-center">
